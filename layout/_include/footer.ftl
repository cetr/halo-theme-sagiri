    ...
    <div class="footer-inner">
        <p><@global.footer /></p>
            ...
            Theme By <a href="https://github.com/feiyangbeyond/halo-theme-sagiri" target="_blank" class="external"
                        rel="nofollow">ruby woo</a> ${theme.version!} <a href="${sitemap_html_url!}" target="_blank">站点地图</a>.</p>
        <p>Made with <i class="fas fa-heart throb" style="color:#d43f57"></i> by <span class="author" itemprop="copyrightHolder">ruby woo</span>.
        </p></div>
</footer>
