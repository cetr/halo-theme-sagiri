...
<#if settings.comment_internal_plugin_js_enable!false>
    <script src="${options.comment_internal_plugin_js!'${theme_base!}/source/lib/comment/halo-comment.min.js'}?v=${theme.version!}"
            type="text/javascript"></script>
<#else>
    <script src="${theme_base!}/source/lib/comment/halo-comment.min.js?v=${theme.version!}"
            type="text/javascript"></script>
</#if>
